...
import ProfileeForm from "../components/ProfileForm";
...
const Settings = () => {
  ...
  return (
    <div className="animate-fade-in">
       ...
       {profile && (
         <ProfileeForm initialData={profile} onSuccess={fetchProfile}/>
       )}
        ...
        {showPasswordModal && <ChangePasswordModal open={showPasswordModal} onClose={() => setShowPasswordModal(false)} />}
      </div>
  )
}
