  ...
  return (
     <form onSubmit={handleSubmit} className="card p-5 sm:p-6 mb-6">
        ...
        <div className='space-y-5'>
            ...
            <textarea  disabled={initialData?.isDeleted}  name="bio" defaultValue={initialData.bio || ""} className={`resize-none ${initialData?.isDeleted ? 'bg-slate-50 text-slate-400 cursor-not-allowed' : ''}`} placeholder='Write a brief bio...'/>
