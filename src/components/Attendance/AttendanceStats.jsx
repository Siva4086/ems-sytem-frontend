...
const AttendanceStats = ({history}) => {
    ...
    const stats = [
        ...
        { label: "Avg. Work Hrs", value: '8.5 hours', icon:ClockIcon  },  
    ]
  return (
    <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-5 mb-8">
        {stats.map((stat) => (
            <div key={stat.label} className="card card-hover flex items-center gap-4 p-5 sm:p-6 relative overflow-hidden group">
